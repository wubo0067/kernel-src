...
#undef REG_TYPE_STR
	...
	for (i = 0; i < ticket->t_res_num; i++)
	{
		...
		xfs_warn(mp, "region[%u]: %s - %u bytes", i,
				 ((r_type <= 0 || r_type > XLOG_REG_TYPE_MAX) ? "bad-rtype" : res_type_str[r_type]),
